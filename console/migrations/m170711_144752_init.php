...
REPLACE INTO `about_contact` (`id`, `about`, `contact`) VALUES
	(1, '<p>Чтобы получить доступ к главной странице сайта <strong>нажмите</strong> на пункт меню <strong>&quot;Идентификация&quot;</strong>.<br />\r\n<strong>Введите</strong> вашу <strong>электронную почту</strong> и <strong>пароль</strong>.<br />\r\n<strong>Нажмите</strong> на кнопку <strong>&quot;Готово&quot;</strong> для доступа к главной странице сайта.</p>\r\n\r\n<p><strong>На главной странице</strong> сайта вы увидите <strong>приветствие</strong> с вашим именем и <strong>кнопкой</strong> с именем вашей организации.<br />\r\nДля дальнейшей работы <strong>нажмите на кнопку&nbsp;</strong>с именем вашей организации.&nbsp;</p>\r\n\r\n<div style=\"background:#eeeeee; border:1px solid #cccccc; padding:5px 10px\">Если <strong>кнопка отсутствует,</strong> значит ваша <strong>организация заблокирована за неуплату</strong>.</div>\r\n\r\n<div style=\"background:#eeeeee; border:1px solid #cccccc; padding:5px 10px\">В случае, если выведено<strong> сообщение о</strong> том, что <strong>ваша организация заблокирована</strong>, необходимо <strong>обратиться по контактам</strong>, узнать которые можно нажав на пункт меню &quot;Наши контакты&quot;. При нажатии на сообщение будет представлена информация о нехватке денежных средств на счету организации.</div>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>При <strong>нажатии на кнопку</strong> с именем вашей организации <strong>запуститься программа для вашей организации</strong>. Чтобы <strong>возвратиться из программы на главную страницу сайта</strong> <strong>нажмите на кнопку (символ дома)</strong> в верхнем левом углу окна программы.</p>\r\n\r\n<div style=\"background:#eeeeee; border:1px solid #cccccc; padding:5px 10px\">Все числа с плавающей запятой вводятся через точку, т.е. &nbsp;2.33.</div>\r\n\r\n<p>В программе есть<strong> три поля</strong>:</p>\r\n\r\n<ul>\r\n	<li>\r\n	<p><strong>грн/кВт</strong> - текущий<strong> тариф за электроэнергию</strong>. Для изменения нажмите на символ &quot;карандаша&quot;, введите число и нажмите на клавиатуре клавишу &quot;Enter&quot;;</p>\r\n	</li>\r\n	<li><strong>Улицы</strong> - <strong>просмотр домов</strong> на этой улице. Для добавления новой улицы нажмите на символ &quot;плюс&quot;, введите текст и нажмите на клавиатуре клавишу &quot;Enter&quot;. Для изменения названия существующей улицы нажмите рядом с ней на символ &quot;карандаша&quot;, введите текст и нажмите на клавиатуре клавишу &quot;Enter&quot;;</li>\r\n	<li><strong>Группы</strong> - аналогично улицам. Сверху <strong>добавлена сумма потребления &nbsp;электроэнергии по показаниям частных счетчиков всех домов группы за все время и потребление электроэнергии группы по показаниям общего счетчика группы</strong>.&nbsp;</li>\r\n</ul>\r\n\r\n<div style=\"background:#eeeeee; border:1px solid #cccccc; padding:5px 10px\">Для <strong>ввода новых показаний общего счетчика группы</strong> (символ &quot;Отверстия для передачи денег&quot;) необходимо нажать чуть выше горизонтальной линии и вести текущие показания. По окончании<strong> </strong>нажать на клавиатуре клавишу &quot;Enter&quot;. Для информации показываются предыдущие показания счетчика.&nbsp; Для <strong>установки начального значения (символ &quot;Плюс&quot;) общего счетчика группы</strong> (последние показания счетчика) на новое значение (это необходимо при смене счетчика или сбросе показаний счетчика) нажать чуть выше горизонтальной линии и вести текущие показания. По окончании нажать на клавиатуре клавишу &quot;Enter&quot;.</div>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>Для <strong>добавления дома</strong> нажмите на символ &quot;<strong>плюс</strong>&quot;, введите номер дома (можно с символами), выберите уже созданную улицу и группу, к которым будет принадлежать этот дом, введите фамилию, имя, отчество и телефон плательщика, и нажмите на<strong> кнопку &quot;Далее&quot;</strong>.<br />\r\nВведите начальное показание счетчика дома и&nbsp; нажмите на <strong>кнопку &quot;Готово&quot;</strong> или на клавиатуре <strong>клавишу &quot;Enter&quot;</strong>.</p>\r\n\r\n<p>У каждого дома выводятся:</p>\r\n\r\n<ul>\r\n	<li><strong>название</strong> его улицы, группы, фамилия, имя, отчество и телефон плательщика;</li>\r\n	<li><strong>текущие показания счетчика</strong>;</li>\r\n	<li><strong>кол-во кВт </strong>которые нужно оплатить (подсвечено красным цветом) или оплаченных наперед (подсвечено зеленым);</li>\r\n	<li><strong>счет </strong>- сколько гривен нужно заплатить (подсвечено красным цветом), сколько гривен оплачено наперед (подсвечено зеленым);</li>\r\n	<li><strong>меню дома</strong> - расположено в самой нижней части окна представляющего этот дом.</li>\r\n</ul>\r\n\r\n<p>В <strong>меню</strong> <strong>дома</strong> есть следующие пункты:</p>\r\n\r\n<ul>\r\n	<li><strong>посмотреть историю </strong>(символ &quot;часы со стрелкой движения против часовой стрелки&quot;). Если на него нажать выводится таблица в которой отображается история внесения показаний и платежей.</li>\r\n	<li><strong>оплатить</strong> (символ &quot;Платежная карта&quot;). Можно ввести <strong>кол-во кВт, которые нужно оплатить </strong>и тогда сумма гривен к оплате автоматически расчитается. Можно ввести <strong>кол-во гривен, которые нужно оплатить</strong> и тогда кол-во оплаченных за эту сумму кВт автоматически расчитается. По окончании <strong>нажать на клавиатуре клавишу &quot;Enter&quot;</strong>. &quot;Кол-во кВт&quot; и &quot;Счет&quot; дома соотвественно изменятся.</li>\r\n	<li><strong>ввести новые показания</strong> (символ &quot;Отверстия для передачи денег&quot;). Для информации показываются последние показания. <strong>Нажать на текст</strong> с последними показанями и <strong>вести текущие показания</strong>. По окончании <strong>нажать на клавиатуре клавишу &quot;Enter&quot;</strong>.</li>\r\n	<li><strong>добавить новый счетчик</strong> (символ &quot;Плюс&quot;). Этот пункт меняет начальное значение счетчика (последние показания счетчика) на новое введенное значение, это необходимо при смене счетчика или сбросе показаний счетчика. <strong>Нажать на текст</strong> &quot;начальные показания нового счетчика&quot; и <strong>вести текущие показания</strong>. По окончании <strong>нажать на клавиатуре клавишу &quot;Enter&quot;</strong>.</li>\r\n	<li><strong>редактировать</strong> (символ &quot;Карандаш&quot;). Изменить фамилию, имя, отчество и телефон плательщика. <strong>Нажать на текст,</strong> который надо изменить, и <strong>изменить его</strong>. По окончании <strong>нажать на клавиатуре клавишу &quot;Enter&quot;.</strong></li>\r\n	<li><strong>взнос</strong> (&quot;символ &quot;Денежная единица&quot;).<strong> Заметка для информации</strong> (например, сумма членского взноса, который необходимо заплатить раз в год), значения вводимые в этом пункте ни на что не влияют. <strong>Нажать на текст &quot;Назначение&quot; и ввести назначение платежа</strong>. <strong>Нажать на текст &quot;Сумма&quot; и ввести необходимую сумму</strong>. По окончании <strong>нажать на клавиатуре клавишу &quot;Enter&quot;</strong>. Справа появляется таблица с указанием месяца, суммы и назначения взноса.</li>\r\n</ul>\r\n\r\n<div style=\"background:#eeeeee; border:1px solid #cccccc; padding:5px 10px\">Для отмены действия пункта, необходимо нажать на него еще раз.</div>\r\n\r\n<p>&nbsp;</p>\r\n', '<p>Руднев Вячеслав</p>\r\n\r\n<p>м.т. - 0509642667</p>\r\n');
